...
export default function DashboardPage() {
  ...
  return (
    <AdminShell>
      <header className="page-header"><div><span className="eyebrow">Platform overview</span><h1>Good to see you, {user?.firstName}.</h1><p>Identity, RBAC, Media, Catalog and the CMS groundwork are active.</p></div><span className="status-pill">Operational</span></header>
